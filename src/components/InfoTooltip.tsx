  ...
  return (
    <span ref={ref} className="relative inline-flex items-center ml-1.5">
      ...
      {open && (
        <span
          ref={popupRef}
          className="absolute top-6 right-0 z-50 w-64 rounded-lg border border-zinc-700 bg-zinc-900 shadow-xl p-3 text-xs text-zinc-300 leading-relaxed block font-normal normal-case tracking-normal"
        >
          {text}
        </span>
      )}
